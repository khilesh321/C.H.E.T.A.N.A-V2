...
from Features.SpeakHotword import takeCommand, speak, speak_welcome
...
def main_code():
    ...
    """ for i in range(3):
        ...
        if (a==pw):
            ...
            threading.Thread(target=(AuthenticateFace)).start()
            play_gif()
            ...
            if "wake up" in query : #or "hey chetana" in query or "hey chetna" in query or "hello chetana" in query or "hello chetna" in query
                ...
                while True:
                    ...
                    #################### --CHETANA-- #####################
                        ...
                        mixer.music.play()
                        from Features.Notification import show_notification
                        show_notification("title = My schedule :- message = content timeout = 15")
